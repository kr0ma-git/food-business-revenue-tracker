...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2025 at 07:09 PM
...
CREATE TABLE `transactions` (
  ...
  `payment_type` enum('Cash','GCash') NOT NULL DEFAULT 'Cash'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `transactions` (`transaction_id`, `product_id`, `user_id`, `quantity`, `created_at`, `is_deleted`, `payment_type`) VALUES
(3, 1, 1, 3, '2025-07-18 00:50:36', 0, 'Cash'),
(4, 2, 8, 3, '2025-07-18 01:00:32', 0, 'Cash'),
(5, 3, 5, 2, '2025-07-18 01:01:40', 0, 'Cash'),
(6, 2, 7, 1, '2025-07-18 01:07:10', 0, 'Cash');
...
(21, 'test', 'test', 'testerTest@gmail.com', '$2y$10$6dSCvuYYwh4GDnhfmWT8KuZ0rxB.xhH1TCHl6PmDBFzHa0mjARC4i', 'admin', '2025-07-17 16:53:59', 0);
